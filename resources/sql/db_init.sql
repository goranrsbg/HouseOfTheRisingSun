CREATE TABLE SETTLEMENTS (
    SETTLEMENT_ID INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 0, INCREMENT BY 1),
    SETTLEMENT_NAME VARCHAR(23) UNIQUE,
	SETTLEMENT_INITIAL CHAR(2) NOT NULL
);
...
CREATE TABLE STREETS (
    STREET_PAK INTEGER PRIMARY KEY CONSTRAINT PAK_CH CHECK (STREET_PAK < 10000000),
    STREET_NAME VARCHAR(47) NOT NULL,
    SETTLEMENT_ID INTEGER,
    CONSTRAINT SETTLEMENT_FK
